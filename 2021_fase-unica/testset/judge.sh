...
problem_dirs=([A]="a_industria" [B]="b_fluxonator" [C]="c_azeitonas" [D]="d_fotos" [E]="e_estacionamento" [F]="f_squarecity" [G]="g_jegues" [H]="h_annagramas" [I]="i_batatinha" [J]="j_power" [K]="k_resgate")
