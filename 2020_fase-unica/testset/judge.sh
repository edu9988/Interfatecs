...
case $PROBLEM_NAME in 
	abbreviating) 
    PROBLEM=A
		PROBLEM_DIR="a_abbreviating"
		TIME_LIMIT=1.0
	;;

	agrupamentos) 
    PROBLEM=B
		PROBLEM_DIR="b_agrupamentos"
		TIME_LIMIT=1.0
	;;
	
	sertanejo) 
    PROBLEM=C
		PROBLEM_DIR="c_sertanejo"
		TIME_LIMIT=1.0
	;;

	chinelandia) 
    PROBLEM=D
		PROBLEM_DIR="d_chinelandia"
		TIME_LIMIT=1.0
	;;
	...
	quociente) 
    PROBLEM=H
		PROBLEM_DIR="h_quociente"
		TIME_LIMIT=1.0
	;;

	reforma) 
    PROBLEM=I
		PROBLEM_DIR="i_reforma"
		TIME_LIMIT=1.0
	;;

	acessibilidade) 
    PROBLEM=J
		PROBLEM_DIR="j_acessibilidade"
		TIME_LIMIT=1.0
	;;

	lubank) 
    PROBLEM=K
		PROBLEM_DIR="k_lubank"
		TIME_LIMIT=1.0
	;;
