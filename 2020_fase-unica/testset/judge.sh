...
problem_dirs=([A]="a_abbreviating" [B]="b_agrupamentos" [C]="c_sertanejo" [D]="d_chinelandia" [E]="e_fifo" [F]="f_escola" [G]="g_festa" [H]="h_quociente" [I]="i_reforma" [J]="j_acessibilidade" [K]="k_lubank")
