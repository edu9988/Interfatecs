...
case $PROBLEM_NAME in 
	...
	robotica) 
    PROBLEM=D
		PROBLEM_DIR="d_robotica"
		TIME_LIMIT=1.0
	;;

	espionagem) 
    PROBLEM=E
		PROBLEM_DIR="e_espionagem"
		TIME_LIMIT=1.0
	;;

	triang) 
    PROBLEM=F
		PROBLEM_DIR="f_triang"
		TIME_LIMIT=1.0
	;;

	pontos) 
    PROBLEM=G
		PROBLEM_DIR="g_pontos"
		TIME_LIMIT=1.0
	;;

	resident) 
    PROBLEM=H
		PROBLEM_DIR="h_resident"
		TIME_LIMIT=1.0
	;;

	inteligencia) 
    PROBLEM=I
		PROBLEM_DIR="i_inteligencia"
		TIME_LIMIT=1.0
	;;

	cegonha) 
    PROBLEM=J
		PROBLEM_DIR="j_cegonha"
		TIME_LIMIT=1.0
	;;
