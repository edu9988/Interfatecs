...
problem_dirs=([A]="a_midsquare" [B]="b_password" [C]="c_pai" [D]="d_cripto" [E]="e_collision" [F]="f_pi" [G]="g_pirocoptero" [H]="h_qbrating" [I]="i_quebra" [J]="j_palavras" [K]="k_piramide" [L]="l_natal")
