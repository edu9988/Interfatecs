...
case $PROBLEM_NAME in 
	antenna) 
    PROBLEM=A
		PROBLEM_DIR="a_antenna"
		TIME_LIMIT=1.0
	;;

	setores) 
    PROBLEM=B
		PROBLEM_DIR="b_setores"
		TIME_LIMIT=1.0
	;;
	
	azulejos) 
    PROBLEM=C
		PROBLEM_DIR="c_azulejos"
		TIME_LIMIT=1.0
	;;
	...
	espetaculo) 
    PROBLEM=E
		PROBLEM_DIR="e_espetaculo"
		TIME_LIMIT=1.0
	;;

	padrao) 
    PROBLEM=F
		PROBLEM_DIR="f_padrao"
		TIME_LIMIT=1.0
	;;
	...
	explosao) 
    PROBLEM=H
		PROBLEM_DIR="h_explosao"
		TIME_LIMIT=1.0
	;;

	aposenta) 
    PROBLEM=I
		PROBLEM_DIR="i_aposenta"
		TIME_LIMIT=1.0
	;;

	linguagem) 
    PROBLEM=J
		PROBLEM_DIR="j_linguagem"
		TIME_LIMIT=1.0
	;;
