...
problem_dirs=([A]="a_pascal" [B]="b_vagas" [C]="c_ord" [D]="d_cadeado" [E]="e_filtragem" [F]="f_piscinas" [G]="g_naves" [H]="h_quadrado" [I]="i_vizinho" [J]="j_derivadas" [K]="k_gemeos" [L]="l_nihans" [M]="m_placas" [N]="n_saau")
