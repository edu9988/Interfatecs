...
case $PROBLEM_NAME in 
	licenseplates) 
    PROBLEM=A
		PROBLEM_DIR="a_licenseplates"
		TIME_LIMIT=1.0
	;;

	brasiliavia) 
    PROBLEM=B
		PROBLEM_DIR="b_brasiliavia"
		TIME_LIMIT=1.0
	;;
	
	policripto) 
    PROBLEM=C
		PROBLEM_DIR="c_policripto"
		TIME_LIMIT=1.0
	;;

	secaomestra) 
    PROBLEM=D
		PROBLEM_DIR="d_secaomestra"
		TIME_LIMIT=1.0
	;;

	apartamento) 
    PROBLEM=E
		PROBLEM_DIR="e_apartamento"
		TIME_LIMIT=1.0
	;;

	retangulo) 
    PROBLEM=F
		PROBLEM_DIR="f_retangulo"
		TIME_LIMIT=1.0
	;;
	...
	inimigosnomapa) 
    PROBLEM=H
		PROBLEM_DIR="h_inimigosnomapa"
		TIME_LIMIT=1.0
	;;

	contagem) 
    PROBLEM=I
		PROBLEM_DIR="i_contagem"
		TIME_LIMIT=1.0
	;;
