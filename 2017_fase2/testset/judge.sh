...
case $PROBLEM_NAME in 
	frequencia) 
    PROBLEM=A
		PROBLEM_DIR="a_frequencia"
		TIME_LIMIT=1.0
	;;

	influencia) 
    PROBLEM=B
		PROBLEM_DIR="b_influencia"
		TIME_LIMIT=1.0
	;;
	
	camadas) 
    PROBLEM=C
		PROBLEM_DIR="c_camadas"
		TIME_LIMIT=1.0
	;;

	superstition) 
    PROBLEM=D
		PROBLEM_DIR="d_superstition"
		TIME_LIMIT=1.0
	;;

	equilibrio) 
    PROBLEM=E
		PROBLEM_DIR="e_equilibrio"
		TIME_LIMIT=1.0
	;;
	...
	paridade) 
    PROBLEM=K
		PROBLEM_DIR="k_paridade"
		TIME_LIMIT=1.0
	;;

	perrito) 
    PROBLEM=L
		PROBLEM_DIR="l_perrito"
		TIME_LIMIT=1.0
	;;
